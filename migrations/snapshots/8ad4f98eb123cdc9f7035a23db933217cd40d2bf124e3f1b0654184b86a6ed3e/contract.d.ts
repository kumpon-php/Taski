...
export type StorageHash =
  StorageHashBase<'8ad4f98eb123cdc9f7035a23db933217cd40d2bf124e3f1b0654184b86a6ed3e'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Task: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly highPriority: CodecTypes['pg/bool@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Task: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly highPriority: CodecTypes['pg/bool@1']['input'];
...
export namespace Models {
  export type public_User = {
    ...
    tasks: public_Task[];
    readonly [RelationKeys]?: 'codes' | 'refreshToken' | 'tasks';
  };
  ...
  export type public_Task = {
    ...
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    highPriority: CodecTypes['pg/bool@1']['output'];
          ...
          readonly Task: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly createdAt: { readonly column: 'createdAt' };
                readonly highPriority: { readonly column: 'highPriority' };
