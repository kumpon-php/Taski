...
export type StorageHash =
  StorageHashBase<'bb36e4e19eee292aa9fac89091b8978fd914f5f3cd8d9d2ba6b0163ff9a0cd1b'>;
        ...
        readonly entries: {
          readonly table: {
            readonly code: {
              ...
              indexes: readonly [
                {
                  readonly name: 'code_userEmail_idx_1fc7e381';
                  readonly prefix: 'code_userEmail_idx';
          ...
          readonly Code: {
            ...
            readonly relations: {
              readonly user: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['userEmail'];
            ...
            readonly relations: {
              readonly codes: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['userEmail'];
                };
              };
              readonly refreshToken: {
                readonly to: {
